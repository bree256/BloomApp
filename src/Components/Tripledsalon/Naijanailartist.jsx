...
import rosepetal from "../../Assets/rosepetal.svg";
import frenchtip from "../../Assets/frenchtip.svg";
import nailfile from "../../Assets/nailfile.svg";
import yellownails from "../../Assets/yellow nails.svg";
import french3 from "../../Assets/french3.svg";
    ...
    <div>
      ...
      <section className={style.section}>
        ...
        <div className={style.imagecontainer}>
          <img src={rosepetal} alt="barberimage" className={style.barber1} />
          <div>
            <img src={frenchtip} alt="braids" className={style.braided} />
            <img src={yellownails} alt="shave" className={style.braided} />
          </div>
          <div className={style.img2}>
            <img src={nailfile} alt="braids" className={style.braided} />
            <img src={french3} alt="braids" className={style.braided} />
          </div>
        </div>
