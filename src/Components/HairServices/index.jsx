        ...
        <nav>
            ...
            <ul>
                ...
                <li>
                   ...
                   <select name="text" id="">services</select> 
                </li>
                <li>
                   <a href="/#">Store</a> 
                </li>
...
export const SecondHeader = () =>{
   ...
   return(
      <div className={style.Header2}>
         ...
         <div  className={style.imgDivs}>
            <img src={img8} alt="" />
            <p>Makeup <br /> Artist</p>
         </div>
         <div  className={style.imgDivs}>
            <img src={img4} alt="" />
            <p>Tattoo and <br /> Piercings</p>
         </div>
            <div  className={style.imgDivs}>
            <img src={img7} alt="" />
            <p>Spa and <br /> Massage</p>
         </div>
         
         <div className={style.inputfield}>
            <input className={style.searchInput} type="text" placeholder="search"onChange={handleChange}
            value={search} onKeyDown={handleKeyDown}
            />
             <div className={style.search}> 
             {
               search === "" ?  <RiSearchLine /> :  <RiCloseFill onClick={handleClose}/>
             }
             ...
             <div className={style.searchResult} >
               {
                  searchData.map((data, index) =>{
                     return(
                        <a href={data.show.url} key={index} target="blank" className={style.searchSuggestionLine}>
                         {data.show.name}
