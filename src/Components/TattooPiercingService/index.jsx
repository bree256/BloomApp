import style from "./tattoo.module.css"
...
export const TattooServiceCard = () => {

    const [showAllCards, setShowAllCards] = useState(false);
    const allCards = [
      { id: 1, name: 'Inked Impressions', imageSrc: img11, distance: '120metres near you', priceRange: '₦-₦₦', rating: 4.71 },
      ...
      { id: 1, name: 'Bold Body Art', imageSrc: imag20, distance: '120metres near you', priceRange: '₦-₦₦', rating: 4.71 },
      { id: 1, name: 'Afro Fusion  Salon', imageSrc: imag21, distance: '520metres near you', priceRange: '₦-₦₦', rating: 4.71 },
      { id: 1, name: 'Tribal Touch Salon', imageSrc: imag22, distance: '970metres near you', priceRange: '₦-₦₦', rating: 4.71 },
      { id: 1, name: 'Afrocentric Salon', imageSrc: imag23, distance: '80metres near you', priceRange: '₦-₦₦', rating: 4.71 },
      { id: 1, name: 'Naija Ink & Needle', imageSrc: imag24, distance: '120metres near you', priceRange: '₦-₦₦', rating: 4.71 },
      { id: 1, name: 'Ethnic Expression', imageSrc: imag25, distance: '120metres near you', priceRange: '₦-₦₦', rating: 4.71 },
      { id: 1, name: 'Masai Edge  Salon', imageSrc: imag26, distance: '100metres near you', priceRange: '₦-₦₦', rating: 4.71 },
      { id: 1, name: 'Ink Master Studio', imageSrc: imag27, distance: '40metres near you', priceRange: '₦-₦₦', rating: 4.71 },
